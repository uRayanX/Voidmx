    ...
    <div className="h-full overflow-y-auto">
      <div className="max-w-6xl mx-auto px-6 md:px-8 xl:px-10 pt-8 md:pt-12 pb-28">
        ...
        <div className="flex items-center justify-between mb-10 md:mb-14">
          ...
          <Link
            to="/settings"
            className="w-10 h-10 flex items-center justify-center rounded-xl bg-white/[0.04] text-white/70 hover:text-white hover:bg-white/[0.1] transition-colors border border-white/[0.05]"
            title="Settings"
          >
            <IconSettings />
          </Link>
